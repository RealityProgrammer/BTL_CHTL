...
namespace CHTL.BUS {
    public class XuLyNguoiDung {
        private TruyCapNguoiDung truyCap = new TruyCapNguoiDung();

        public NguoiDung DangNhap(string tenDangNhap, string matKhau)
        {
            return truyCap.DangNhap(tenDangNhap, matKhau);
        }

        public List<NguoiDung> LayDanhSachNguoiDung()
        {
            return truyCap.LayDanhSachNguoiDung();
        }
        ...
        {
            return truyCap.TimKiemNguoiDung(tuKhoa);
        }
    }
}